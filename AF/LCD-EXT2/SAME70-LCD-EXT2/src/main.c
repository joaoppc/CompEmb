...
void RTC_Handler(void)
{
	...
	if ((ul_status & RTC_SR_SEC) == RTC_SR_SEC) {
		...
		if(temp <25){
			...
			ili9488_draw_string(10, 200, (uint8_t *)itoa (temp,buffer,10));
			ili9488_draw_string(35, 200, "C");
			ili9488_draw_string(30, 320, (uint8_t *)itoa (hora,buffer,10));
			ili9488_draw_string(40, 320, ":");
			ili9488_draw_string(50, 320, (uint8_t *)itoa (minuto,buffer,10));
			ili9488_draw_string(60, 320, ":");
			ili9488_draw_string(70, 320, (uint8_t *)itoa (segundo,buffer,10));
			ili9488_set_foreground_color(COLOR_CONVERT(COLOR_GREEN));
			ili9488_draw_filled_circle(180,260,(temp-20)*9);
			delay_ms(500);
